        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('create.subcategory')" :active="request()->routeIs('create.subcategory')">
                        {{ __('Create Subcategory') }}
                    </x-nav-link>
                    <x-nav-link :href="route('create.post')" :active="request()->routeIs('create.subcategory')">
                        {{ __('Create Post') }}
                    </x-nav-link>
                    <x-nav-link :href="route('profiles')" :active="request()->routeIs('profiles')">
                        {{ __('Show all profiles') }}
                    </x-nav-link>
                    <x-nav-link :href="route('show.cats')" :active="request()->routeIs('profiles')">
                        {{ __('Callboard') }}
                    </x-nav-link>
                </div>
            </div>
